        ...
        <div className="h-[calc(100vh-88px)] overflow-y-auto px-6 py-6">
          ...
          <div className="mb-8 grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div
              ...
              className={`group cursor-pointer rounded-3xl p-5 transition-all duration-300 ${
                active === "cert"
                  ? "bg-gradient-to-r from-green-500 to-emerald-600 text-white shadow-xl scale-[1.03]"
                  : "bg-white hover:-translate-y-1 hover:shadow-xl"
              }`}
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className={`text-xs ${
                    active === "cert" ? "text-white/80" : "text-gray-500"
                  }`}>
                    Compliance
                  </p>
            ...
            <div
              ...
              className={`group cursor-pointer rounded-3xl p-5 transition-all duration-300 ${
                active === "pack"
                  ? "bg-gradient-to-r from-orange-500 to-amber-500 text-white shadow-xl scale-[1.03]"
                  : "bg-white hover:-translate-y-1 hover:shadow-xl"
              }`}
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className={`text-xs ${
                    active === "pack" ? "text-white/80" : "text-gray-500"
                  }`}>
                    Storage
                  </p>
