...
await fetch(`/api/packaging/${editing.Id}`, {
 ...
 await fetch(`/api/packaging/${id}`, {
  ...
  const columnDefs = [
    ...
    { field: "Material", editable: true   , wrapText:true,  autoHeight:true,},
     { field: "NetWeight", editable: true   , wrapText:true,  autoHeight:true,},
...
{/* POPUP MODAL */}
  ...
  <div className="bg-gray-50 p-5 rounded-xl w-[350px] shadow-2xl">
         ...
         <form className="flex flex-col" onSubmit={submit}>
            ...
            {/* Name */}
            <input
           className={`w-full px-3 py-2 border rounded-lg ${error?.Material ? "border-red-500" : "border-gray-300"}`}
...
<br/>
                <input
           className={`w-full px-3 py-2 border rounded-lg ${error?.NetWeight ? "border-red-500" : "border-gray-300"}`}
              placeholder="NetWeight Name"
